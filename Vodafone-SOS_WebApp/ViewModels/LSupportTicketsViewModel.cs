...
{
    public class LSupportTicketsViewModel
    {
        ...
        [RestrictSpecialChar]  /*AllowSomeRestrictSpecialChar*/
        ...
        public DateTime LstSearchTicketFromDate { get; set; }
        public DateTime LstSearchTicketToDate { get; set; }

        [RestrictSpecialChar]
        public string LstTicketSearchString { get; set; }
    ...
    public class LSupportResponsesViewModel
    {
        public int Id { get; set; }
        ...
        public Boolean blnSupportUserLoggedIn { get; set; }
    }
    public class RSupportTeamsViewModel
    {
        public int Id { get; set; }
        [RestrictSpecialChar]
        public string RstTeamName { get; set; }
